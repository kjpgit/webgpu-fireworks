...
export const POINTER_BUCKETS      = 8
export const POINTER_BUFFER_SIZE  = POINTER_BUCKETS * MAX_FINE_SHAPES * 4   // == 32MB!
...
const POINTER_BUCKETS     = ${POINTER_BUCKETS};
...
struct MiscData {
    ...
    @align(16)  num_fine_shapes_per_row:  array<atomic<u32>, POINTER_BUCKETS>,
